...
INSERT INTO `matters` VALUES (1,'Consulta al CEO'),(2,'Consulta al Gerente Comercial'),(3,'Consulta al Gerente de Marketing'),(4,'Otras consultas');
...
CREATE TABLE `messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_matters_idx` (`matter_id`),
  CONSTRAINT `fk_matters` FOREIGN KEY (`matter_id`) REFERENCES `matters` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `users` VALUES (2,'Alma','Marino','almamarino@hotmail.com','$2b$12$g98FBvJReCBcKvdCm9LIdOm/diCFjYtgV2SnX95ttevyep1K6WoDy','1996-01-20','default.png',1,'2021-03-24 23:27:36','2021-03-24 23:27:36',2),(3,'sergio','Mariño','spmarino@hotmail.com','$2b$12$2/V2gHZB39pV63q.ILfZ5u2Xdm71I9bKdPSQwkQglMGagmgFGoOfq','1992-08-23','avatar-1616632306220.png',2,'2021-03-25 00:31:46','2021-03-25 00:31:46',1),(4,'Adrian','Marino','adrianmarino@hotmail.com','$2b$12$i//tbXBvVbGeqihqS.UkBey7a54b6jce2W4EKmUSNx7wpG9zYDFoO','2001-06-01','default.png',2,'2021-04-06 01:48:35','2021-04-06 01:48:35',1),(5,'adrian','marino','adrian@hotmail.com','$2b$12$TTt8HVVrWZXZokymcvGPyuwtGo0pnPrON108bnIaLHvjOH38PpfUm','1996-06-01','default.png',1,'2021-04-07 21:28:17','2021-04-07 21:28:17',1),(6,'Jessica','Pintos','yessica@hotmail.com','$2b$12$tWyMgm9raTKsEhsnoQURQObCkOPSGJLhVhLEg8wr.bDKf8VWLvWvq','1997-02-24','default.png',1,'2021-04-07 21:31:53','2021-04-07 21:31:53',2),(8,'fernanndo','Granatelli','fernando@hotmail.com','$2b$12$OZHofeD/N2VvewKvm1.5YOHEGUWVczyq/eviOsK5PTr9XwMLtGMLe','1966-01-23','default.png',2,'2021-04-09 21:45:54','2021-04-09 21:45:54',1),(9,'Nicolas','Mariño','nicolasmarino@gmail.com','$2b$12$qzzsTWvOAB7sktdcYHqSOORhw5ST28IygjZVtqJGiGvn3FzBO6op6','1996-02-07','default.png',1,'2021-04-15 00:53:53','2021-04-15 00:53:53',1);
...
-- Dump completed on 2021-04-15 16:09:20
